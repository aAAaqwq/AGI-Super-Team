...
示例:
  ...
  python media_publisher.py check-login baijiahao --snapshot snapshot.txt
    ...
    open_parser.add_argument("platform", choices=["baijiahao", "sohu", "zhihu", "wechat", "xiaohongshu", "douyin"], help="平台代码")

    # info命令 - 查看平台信息
    info_parser = subparsers.add_parser("info", help="查看平台信息")
    info_parser.add_argument("platform", choices=["baijiahao", "sohu", "zhihu", "wechat", "xiaohongshu", "douyin"], help="平台代码")

    # workflow命令 - 生成工作流程
    workflow_parser = subparsers.add_parser("workflow", help="生成完整工作流程")
    workflow_parser.add_argument("platform", choices=["baijiahao", "sohu", "zhihu", "wechat", "xiaohongshu", "douyin"], help="平台代码")
    ...
    login_parser.add_argument("platform", choices=["baijiahao", "sohu", "zhihu", "wechat", "xiaohongshu", "douyin"], help="平台代码")
    login_parser.add_argument("--snapshot", "-s", help="快照文件路径")

    # detect-popup命令 - 检测弹窗
    popup_parser = subparsers.add_parser("detect-popup", help="检测页面弹窗")
    popup_parser.add_argument("platform", choices=["baijiahao", "sohu", "zhihu", "wechat", "xiaohongshu", "douyin"], help="平台代码")
    popup_parser.add_argument("--snapshot", "-s", help="快照文件路径")

    # 命令前缀 - 快捷方式
    parser.add_argument("quick_platform", nargs="?", choices=["baijiahao", "sohu", "zhihu", "wechat", "xiaohongshu", "douyin"],
