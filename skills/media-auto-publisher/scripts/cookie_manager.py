...
def main():
    ...
    add_parser.add_argument("platform", choices=["baijiahao", "sohu", "zhihu", "wechat", "xiaohongshu", "douyin"], help="平台")
    ...
    list_parser.add_argument("--platform", choices=["baijiahao", "sohu", "zhihu", "wechat", "xiaohongshu", "douyin"], help="过滤平台")

    # 删除账号
    del_parser = subparsers.add_parser("delete", help="删除账号")
    del_parser.add_argument("platform", choices=["baijiahao", "sohu", "zhihu", "wechat", "xiaohongshu", "douyin"], help="平台")
    del_parser.add_argument("account", help="账号名称")

    # 导出Cookie
    export_parser = subparsers.add_parser("export", help="导出Cookie")
    export_parser.add_argument("platform", choices=["baijiahao", "sohu", "zhihu", "wechat", "xiaohongshu", "douyin"], help="平台")
    ...
    info_parser.add_argument("platform", choices=["baijiahao", "sohu", "zhihu", "wechat", "xiaohongshu", "douyin"], nargs="?",
                             help="平台代码（留空显示所有）")
