...
| aixn (XAPI) | Playwright / Browser Tool | `~/.playwright-data/aixn` | ✅ 可用 |
| GitHub Copilot | Playwright 抓取 | `~/.playwright-data/github` | ✅ 可用 |
| 性价比 API (xingjiabiapi) | Playwright 抓取 | `~/.playwright-data/xingjiabiapi` | ✅ 可用 |
